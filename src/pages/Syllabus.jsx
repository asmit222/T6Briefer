...
class Syllabus extends Component {
  constructor(props) {
    ...
    this.handleUpdateContactSelected =
      this.handleUpdateContactSelected.bind(this);
    this.handleUpdateInstrumentSelected =
      this.handleUpdateInstrumentSelected.bind(this);
    this.handleUpdateFormationSelected =
      this.handleUpdateFormationSelected.bind(this);
    this.handleUpdateNavigationSelected =
      this.handleUpdateNavigationSelected.bind(this);
  ...
  handleClickOpenSyllabus(e) {
    ...
    if (subject === "contact") {
      ...
      let oldModalState = this.state.syllabusModals;
