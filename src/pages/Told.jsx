...
class Told extends Component {
  ...
  minPower60KNGP = (temperature) => {
    if (temperature <= 42) {
      ...
      throw new Error("Temperature exceeds our bounds.");
    }
  };
  ...
  updateDataKNSE = () => {
    fetch("https://t6brieferserver.fly.dev/getWeatherDataKNSE")
      ...
      .then((data) => {
        ...
        const temperatureKNSE = data.temperature.value;
        const windSpeedKNSE = data.wind_speed.value;
        const windDirectionKNSE = data.wind_direction.value;
        const headwindKNSE = this.setHeadwindKNSE(
          windDirectionKNSE,
          windSpeedKNSE,
          this.state.runwayHeadingKNSE
        );
      ...
      if (
        ...
        fetch(
          ...
          .then((data) => {
            ...
            const temperatureKNSE = xml.getElementsByTagName("temp_c")[0].value;
            const windSpeedKNSE =
              xml.getElementsByTagName("wind_speed_kt")[0].value;
            const windDirectionKNSE =
  ...
  updateDataKNGP = () => {
    fetch("https://t6brieferserver.fly.dev/getWeatherDataKNGP", {
      ...
      .then((response) => response.json())
      .then((data) => {
        console.log("KNGP Data: ", data);
        this.temperatureKNGP = data.temperature.value;
        this.windSpeedKNGP = data.wind_speed.value;
        this.windDirectionKNGP = data.wind_direction.value;
        ...
        fetch(
          ...
          .then((data) => {
            ...
            this.temperatureKNGP = Number(
              xml.getElementsByTagName("temp_c")[0].textContent
            );
            this.windSpeedKNGP = Number(
              xml.getElementsByTagName("wind_speed_kt")[0].textContent
            );
            this.windDirectionKNGP = Number(
              xml.getElementsByTagName("wind_dir_degrees")[0].textContent
            );
            this.setHeadwindKNGP(
              this.windDirectionKNGP,
              this.windSpeedKNGP,
            ...
            this.setState({
              KNGPMetar: xml.getElementsByTagName("raw_text")[0].textContent,
              metarLoadingKNGP: false,
            });
            console.log(
              "KNGP",
